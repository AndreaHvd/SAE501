<?php
    ...
    function listerProduitsParCategorie($categorie_id){
        global $api_url_base;
        // On enlève "/produit" pour revenir à la racine de l'API (http://api:8000)
        $api_root = str_replace("/produit", "", $api_url_base);
        $url = $api_root . "/categorieproduit/" . (int)$categorie_id;
